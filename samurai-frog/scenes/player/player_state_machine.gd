...
func _sync_animation_conditions() -> void:
	if animation_tree == null or current_state == null:
		return
	animation_tree.set("parameters/conditions/is_falling", current_state.name == "Falling")
	animation_tree.set("parameters/conditions/is_walled", current_state.name == "Walled")
	...
	animation_tree.set("parameters/conditions/attack_1_requested", requested_attack_animation == &"attack_1")
	animation_tree.set("parameters/conditions/attack_2_requested", requested_attack_animation == &"attack_2")
	animation_tree.set("parameters/conditions/attack_3_requested", requested_attack_animation == &"attack_3")
